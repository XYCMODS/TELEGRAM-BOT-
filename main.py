...
def home():
    ...
    <body style="font-family: Arial; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 50px;">
        <h1>File Host By @ABHISHEKXMODS</h1>
...
# --- Configuration ---
TOKEN = '8498764915:AAEbR9dPbo8TYWt2meRG29tBv_YPFzNdoJM'
OWNER_ID = int(os.getenv('OWNER_ID', '6905999968'))
ADMIN_ID = int(os.getenv('ADMIN_ID', '8581575196'))
YOUR_USERNAME = os.getenv('BOT_USERNAME', '@ABHISHEKXMODS')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/+HGwkGETLZ68xMDJl')
